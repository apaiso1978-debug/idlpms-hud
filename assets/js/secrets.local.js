...
// ============================================================================
// This file holds sensitive API keys for local development.
// It is explicitly ignored by Git to prevent leaking credentials.
// In production, these should be omitted or injected via secure environments.
...
window.LOCAL_SECRETS = {
    ...
    // Netlify API Token for Bandwidth widgets
    NETLIFY_TOKEN: 'nfp_5U2EHaoVnAYAfXobrm5DvPiRDVR59sz2cc5e'
};
